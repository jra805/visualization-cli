...
describe("bus-factor", () => {
  it("detects single-author files as bus factor = 1", () => {
    ...
    addNode(graph, { id: absPath("src/app.ts"), filePath: absPath("src/app.ts"), label: "app", moduleType: "component", loc: 100, directory: "src" });
  ...
  it("detects multi-author files as bus factor > 1", () => {
    const graph = createGraph();
    addNode(graph, { id: absPath("src/shared.ts"), filePath: absPath("src/shared.ts"), label: "shared", moduleType: "util", loc: 50, directory: "src" });
  ...
  it("only includes files that exist in the graph", () => {
    const graph = createGraph();
    addNode(graph, { id: absPath("src/a.ts"), filePath: absPath("src/a.ts"), label: "a", moduleType: "util", loc: 10, directory: "src" });
